              ...
              <div className="mt-10 grid gap-8 md:grid-cols-2">
                ...
                <div className="bg-gradient-to-br from-primary-50 to-white rounded-xl p-6 shadow-md border border-primary-100">
                  ...
                  <p className="mt-4 text-sm text-gray-500 flex items-center justify-center">
                    <svg className="h-4 w-4 text-primary-500 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    Or call us directly: <a href="tel:+15551234567" className="text-primary-600 hover:text-primary-500 hover:underline ml-1">+1 (555) 123-4567</a>
                  </p>
                </div>
              </div>
            </div>
