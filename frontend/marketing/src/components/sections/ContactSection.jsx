...
const ContactSection = () => {
  ...
  return (
    <SectionContainer background="gradient" id="contact">
          ...
          >
            <div className="max-w-md mx-auto lg:max-w-none">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Have questions or want to learn more about Customate.ai? Reach out to our team and we'll get back to you shortly.
              </p>
