...
const ChatIcons = {
  Widget: () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
      ...
      <polyline points="7.5,16 12,21 12,12"/>
      <polyline points="21,8 12,12 3,8"/>
...
const WidgetChat = ({ message }) => {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-xl h-full flex flex-col">
      {/* Chat Header */}
      <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-3 flex items-center">
        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center mr-3">
      ...
      <div className="p-4 bg-gray-50 flex-grow overflow-y-auto">
        ...
        <div className="mb-4 flex items-start">
          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 flex items-center justify-center mr-3 flex-shrink-0">
            <span className="text-xs font-bold text-white">AI</span>
          </div>
          <div className="bg-white p-3 rounded-2xl rounded-tl-md shadow-sm border">
            <p className="text-gray-800 text-sm">👋 Hello! How can I help you today?</p>
          </div>
        </div>
        
        <div className="mb-4">
          <div className="bg-orange-500 max-w-xs ml-auto p-3 rounded-2xl rounded-tr-md">
            <p className="text-white text-sm">{message.question}</p>
          </div>
        ...
        <div className="mb-4 flex items-start">
          ...
          <div className="bg-white p-3 rounded-2xl rounded-tl-md shadow-sm border max-w-xs">
            <p className="text-gray-800 text-sm">{message.answer}</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-white border-t border-gray-200 flex items-center">
        <div className="flex-grow bg-gray-100 rounded-full px-4 py-2 flex items-center">
          <span className="text-gray-500 text-sm flex-grow">Type your message...</span>
        ...
        <button className="ml-3 w-8 h-8 bg-gradient-to-r from-orange-500 to-amber-500 rounded-full flex items-center justify-center hover:from-orange-600 hover:to-amber-600 transition-colors">
          <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
...
const GmailChat = ({ message }) => {
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-xl h-full flex flex-col">
      {/* Gmail Header */}
      <div className="bg-[#EA4335] p-3 flex items-center">
        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center mr-3">
        ...
        <div className="flex-grow">
          <h3 className="text-white font-medium">support@customate.ai</h3>
          <p className="text-xs text-red-100">AI-powered email support</p>
        </div>
      </div>
      
      {/* Email Thread */}
      <div className="p-4 bg-gray-50 flex-grow overflow-y-auto space-y-4">
        {/* Incoming Email */}
        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
          <div className="flex items-center mb-3 pb-2 border-b border-gray-100">
            ...
            <div className="flex-grow">
              ...
              <p className="text-xs text-gray-500">To: support@customate.ai</p>
            </div>
            <span className="text-xs text-gray-400">2:30 PM</span>
          </div>
          <p className="text-sm text-gray-800 leading-relaxed">{message.question}</p>
        </div>
        
        {/* AI Reply */}
        <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-4 border border-red-200 shadow-sm">
          <div className="flex items-center mb-3 pb-2 border-b border-red-100">
            <div className="w-8 h-8 rounded-full bg-[#EA4335] flex items-center justify-center mr-3">
              <span className="text-xs font-bold text-white">AI</span>
            </div>
            <div className="flex-grow">
              <p className="text-sm font-medium text-gray-900">support@customate.ai</p>
              <p className="text-xs text-gray-500">To: customer@example.com</p>
            </div>
            <span className="text-xs text-gray-400">2:31 PM</span>
          </div>
          <p className="text-sm text-gray-800 leading-relaxed">{message.answer}</p>
          <div className="mt-3 pt-2 border-t border-red-100">
            <p className="text-xs text-gray-500">✨ Powered by Customate AI</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-white border-t border-gray-200">
        <div className="flex items-center text-gray-500 text-sm">
          ...
          <span>AI automatically replies with contextual responses</span>
        </div>
      </div>
    </div>
  );
...
const IntegrationsSection = () => {
  ...
  const [activeChannel, setActiveChannel] = useState("widget");
  ...
  const channels = {
    widget: {
      ...
      message: {
        ...
        answer: "Our widget embeds directly into your website with just one line of code. Visitors can chat with your AI instantly, getting answers from your knowledge base 24/7 without leaving your site."
      }
    },
    whatsapp: {
      id: "whatsapp",
    ...
    gmail: {
      ...
      color: "#EA4335",
      message: {
        question: "I need help with my recent purchase",
        answer: "I'd be happy to help you with your purchase! Could you please provide your order number? I can check the status, help with returns, or answer any questions you might have about your order."
      }
    }
  };
  ...
  const renderChannelInterface = () => {
    ...
    switch (activeChannel) {
      case "widget":
        return <WidgetChat message={message} />;
      case "whatsapp":
      ...
      case "gmail":
        return <GmailChat message={message} />;
      default:
        return <WidgetChat message={message} />;
    }
  };
