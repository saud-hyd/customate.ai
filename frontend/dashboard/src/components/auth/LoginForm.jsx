// Path: frontend/dashboard/src/components/auth/LoginForm.jsx
// Usage: Login form component with integrated logo for authentication pages
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gray-50 text-gray-500">{t('auth:login.continueWith')}</span>
              </div>
            </div>
