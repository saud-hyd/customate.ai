// Path: frontend/dashboard/src/components/layout/Sidebar.jsx
// Usage: Minimal, clean sidebar navigation designed to fit without scrolling and align with website theme
        ...
        <div className="space-y-1">
          ...
          >
            {({ isActive }) => (
              <>
                <svg className={`w-5 h-5 mr-3 ${isActive ? 'text-white' : 'text-gray-400'}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 9.50006C14 11.9853 11.9853 14 9.5 14C7.01472 14 5 11.9853 5 9.50006C5 7.01478 7.01472 5 9.5 5C11.9853 5 14 7.01478 14 9.50006Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          >
            {({ isActive }) => (
              <>
                <svg className={`w-5 h-5 mr-3 ${isActive ? 'text-white' : 'text-gray-400'}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.428 15.428a2.571 2.571 0 11-5.143 0 2.571 2.571 0 015.143 0z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M7.242 12.57l10.15 5.85" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M8.85 5.578L19 11.428l-2.286 1.315" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
