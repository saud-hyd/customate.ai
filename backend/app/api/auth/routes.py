...
async def login_for_access_token(
    ...
    """OAuth2 compatible token login, using API key as the password."""
    ...
    # Generate token for compatibility with frontend
    ...
    return {
        ...
        "api_key": client.api_key  # Return API key for direct use
    }
